//za završnu potjeru
//u zavrsnoj potjeri se pobjeđuje ako se u 2 minute točno odgovori na 7 pitanja

class Zavrsna_potjera{
...
"Tko se smatra izumiteljem frižidera?",
  ...
  void iscrtaj(){
    ...
    if( vrime <= 0 ){
      zav_pot = false; //kad istekne vrijeme, gotovi smo sa završnom potjerom
